...
export const Vouchers: React.FC<VouchersProps> = ({ state }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {selectedVoucher && (
          <div className="flex flex-col items-center bg-gray-100 p-4 rounded-lg print:p-0 print:bg-white print:block">
            {/* SCROLL WRAPPER for Small Screens */}
            <div className="w-full overflow-x-auto print:overflow-visible flex justify-center pb-4">
                {/* INVOICE CONTAINER - Fixed Width A4-ish */}
                <div className="bg-white w-[210mm] min-w-[210mm] min-h-[297mm] shadow-xl p-8 md:p-12 print:shadow-none print:w-full print:min-w-0 print:min-h-0 print:p-0 text-gray-800 flex flex-col mx-auto">
            ...
            {selectedVoucher && (
                <div className="mt-4 flex justify-end print:hidden w-full max-w-[210mm]">
                    <button 
                    onClick={handlePrint}
